...
type ChartContainerProps = Omit<React.ComponentProps<typeof RechartsPrimitive.ResponsiveContainer>, "children"> & {
  config: ChartConfig
...
>(
  (
    ...
    if (payload[0]?.payload?.name && typeof payload[0]?.payload?.value !== 'undefined') {
        ...
        return (
            ...
            >
                <div className="font-semibold text-center mb-1">{payload[0].name}</div>
